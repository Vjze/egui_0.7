...
pub async fn sn_work(s: String) -> Vec<Vec<String>> {
...
pub async fn box_work(s: String) -> (Vec<Vec<String>>, usize) {
    let mut client = client().await;
    let query_ty = format!(
...
pub async fn box_work_test(s: String) -> (Vec<DataInfo>, usize) {
...
pub async fn carton_work(s: String) -> (Vec<Vec<String>>, usize) {
    let mut client = client().await;
    let mut client_1 = client_1().await;
    let mut client_2 = client_2().await;
    let car_no = s.clone();
