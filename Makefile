...
# Linux
APPIMAGE_NAME = Egui_Tools.AppImage
APPIMAGE_DIR = $(RELEASE_DIR)/AppDir
APPIMAGE_DESKTOP_FILE = $(RESOURCES_DIR)/linux/Egui_Tools.desktop
APPIMAGE_ICON_FILE = $(RESOURCES_DIR)/icons/256x256/logo.png

TAR_NAME = Egui_Tools.tar.gz
...
ifdef OPENGL
  DMG_NAME :=Egui_Tools-opengl.dmg
  APPIMAGE_NAME :=Egui_Tools-opengl.AppImage
else
  DMG_NAME :=Egui_Tools.dmg
  APPIMAGE_NAME :=Egui_Tools.AppImage
  FEATURE_FLAG :=
endif
